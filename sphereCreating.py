...
for i in range(1000):
    ...
    fig.write_image(place+"images/sphere"+str(i)+".png")
    image = cv.imread(place+"images/sphere"+str(i)+".png")
    ...
    w=w/width
    h=h/height
    f = open(place+"labels/sphere"+str(i)+".txt", "x")
    f.write("1 "+str(x+w/2)+" "+str(y+h/2)+" "+str(w)+" "+str(h))
    f.close()